let hoc = (confirmText, cancelText) => {
  return Component => {
    return {
        ...
        return (
          ...
          >
            ...
            <template slot='footer'>
              <el-button onClick={ this.cancel }>{ cancelText }</el-button>
              <el-button type='primary' onClick={ this.handleConfirmClick } loading={loading}>
                { confirmText }
              </el-button>
            </template>
          </el-dialog>
